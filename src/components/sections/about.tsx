...
const values = [
  {
    ...
    color: "bg-[#000]/10 group-hover:bg-[#000]/18",
    iconColor: "text-[#000]",
  },
  {
    icon: Lightbulb,
    ...
    color: "bg-[#555]/10 group-hover:bg-[#555]/18",
    iconColor: "text-[#555]",
  },
  {
    icon: Rocket,
    ...
    color: "bg-[#777]/15 group-hover:bg-[#777]/25",
    iconColor: "text-[#000]",
  },
  {
    icon: Users,
    ...
    color: "bg-[#222]/10 group-hover:bg-[#222]/18",
    iconColor: "text-[#222]",
  },
];
...
export function About() {
  return (
    <section id="about" className="py-28 lg:py-36 relative bg-[#fafafa]">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="order-1 lg:order-2 animate-fade-in-right [animation-delay:150ms]">
            <p className="text-[#555] leading-relaxed text-lg mb-6">
              We are based in{" "}
              <span className="text-[#000] font-semibold">Bangalore, India</span>{" "}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
              {values.map((value) => (
                ...
                >
                  ...
                  <h3 className="font-semibold text-sm mb-1 text-[#000]">{value.title}</h3>
                  <p className="text-xs text-[#555] leading-relaxed">{value.description}</p>
                </div>
              ))}
            </div>
